...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # embed positions
        hidden_states = inputs_embeds.to(self.embed_tokens.weight.device)
        ...
        for i, decoder_layer in enumerate(self.layers):
            ...
            #     attention_mask = kwargs['add_attn_fn'](attention_mask, kwargs['attn_value'], kwargs['add_idx'])
            ...
            if self.gradient_checkpointing and self.training:
                layer_outputs = self._gradient_checkpointing_func(
                    ...
                    hidden_states,
                    attention_mask.to(decoder_layer.input_layernorm.weight.device) if attention_mask is not None else None,
                ...
                layer_outputs = decoder_layer(
                    hidden_states,
                    attention_mask=attention_mask.to(decoder_layer.input_layernorm.weight.device) if attention_mask is not None else None,
